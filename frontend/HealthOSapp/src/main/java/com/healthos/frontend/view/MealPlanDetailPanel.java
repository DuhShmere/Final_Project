...
public class MealPlanDetailPanel extends JPanel {
    ...
    private JPanel makeDaySection(MealPlanData.DayPlan day, MongoDBHelper db, String username) {
        ...
        section.setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createLineBorder(new Color(220, 220, 220, 220), 1, true),
    ...
    private JPanel makeMealRow(MealPlanData.Recipe recipe, Color bg, String mealType, MongoDBHelper db,
            String username) {
        JPanel row = new JPanel(new BorderLayout(10, 0));
        row.setBackground(bg);
        row.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(bg.darker(), 1, true),
