...
public class MealPlanPanel extends JPanel {
    public MealPlanPanel(MongoDBHelper db, String username, Runnable onPlanSelected) {
        ...
        if (targetCalories > 0) {
            JLabel hintLabel = new JLabel(
                    "Daily Calorie Target: " + targetCalories + " kcal - ⭐ marks plan most suited for you",
                    JLabel.CENTER);
    ...
    private JPanel makePlanCard(MealPlanData.MealPlan plan, String savedPlan, boolean recommended, MongoDBHelper db,
        ...
        selectBtn.addActionListener(e -> {
            ...
            JOptionPane.showMessageDialog(this, plan.name + " is now currently active", "Plan is selected",
