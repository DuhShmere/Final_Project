...
public class MealPlanData {
    ...
    public static MealPlan[] getPlansByCategory(String category) {
        ...
        int count = 0;
        for (MealPlan p : all) {
            if (p.category.equals(category)) count++;
        }
        MealPlan[] result = new MealPlan[count];
        int i = 0;
        for (MealPlan p : all) {
            if (p.category.equals(category)) result[i++] = p;
        }
        return result;
    }
    ...
    private static MealPlan getWeightLossPlan2() {
        ...
        return new MealPlan("Clean Burn Plan", "Weight Loss",
            "~1500 kcal/day with balanced macros and varied meals to keep you satisfied while losing weight.", days);
    }
    ...
    private static MealPlan getMaintenancePlan1() {
        ...
        return new MealPlan("Balanced Living Plan", "Maintenance",
            "~2000 kcal/day with a balanced macro split to maintain your current weight and fuel daily life.", days);
    }
